    ...
    async def help_command(self, interaction: disnake.ApplicationCommandInteraction):
        ...
        embed.add_field(
            ...
            value="**Описание:** Создает голосовой канал с указанными параметрами\n"
                  ...
                  "• `amount` - Максимальное количество участников(Необязательное поле)\n"
        ...
        embed.add_field(
            ...
            value="**Описание:** Исключает участника с сервера\n"
                  ...
                  "**Использование:** `/kick user: @username reason: Нарушение правил`",
            inline=False
        )
        ...
        embed.add_field(
            ...
            value="**Описание:** Блокирует участника на сервере\n"
                  ...
                  "• `reason` - Причина блокировки (Необязательное поле)\n"
                  "**Использование:** `/ban user: @username reason: Нарушение правил`",
            inline=False
        )
