...
class TestBanMemberWithDeletion(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
    ...
    async def test_ban_member_with_deletion(
        self,
        mock_get_session,
        MockGuildService
    ):
        ...
        response = self.client.put(
            "/api/v1/guilds/123456789012345678/bans/876543210987654321",
            json={
        ...
        mock_guild_service.ban_member_with_message_deletion.assert_called_once()
